...
public class ForkX2 extends NemaComponent {
    ...
    public void execute(ComponentContext cc) throws ComponentExecutionException,
        ...
        String fn = cc.getProperty(this.s_REPLICATION_METHOD);
        ...
        try {
            ...
            Object dat = cc.getDataComponentFromInput(this.s_INPUT_1);
            switch (repMode) {
            case 0: //REFERENCE
                cc.pushDataComponentToOutput(this.s_OUTPUT_1, dat);
                cc.pushDataComponentToOutput(this.s_OUTPUT_2, dat);
                break;
            ...
            case 1: //CLONE Shallow Copy
                ...
                cc.pushDataComponentToOutput(this.s_OUTPUT_1, dat);
                cc.pushDataComponentToOutput(this.s_OUTPUT_2, obj);
                break;
            ...
            case 4: //CUSTOM
                ...
                String meth = cc.getProperty(this.s_CUSTOM_COPY_METHOD_NAME);
                obj = null;
