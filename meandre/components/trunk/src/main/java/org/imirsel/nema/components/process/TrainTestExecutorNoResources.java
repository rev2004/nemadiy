...
@Component(creator = "Kris West", description = "This component performs " +
		...
		"sets of input training files, input test file and output files for " +
		"it to produce.",
		name = "TrainTestExecutorNoResources", tags = "profile process execution")
public class TrainTestExecutorNoResources extends RemoteExecutorBase {
