/*
 * WekaVotedPerceptronClassifier.java
 *Author: Qin Wei
 * Created on November 2, 2006, 3:13 PM
...
public class WekaVotedPerceptronClassifier implements SignalClassifier {

    weka.classifiers.functions.VotedPerceptron theTree = null;
    String[] classnames = null;
    private String VotedPerceptronOptions = "-I 2";
     ...
     */
    public WekaVotedPerceptronClassifier() {
    }

    /**
     * Creates a new instance of TrainWekaClassifier
     *
     * @param options Options for VotedPerceptronClassifier
     */
    public WekaVotedPerceptronClassifier(String options) {
        VotedPerceptronOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.functions.VotedPerceptron.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theTree = new VotedPerceptron();

        // parse options        
        StringTokenizer stOption = new StringTokenizer(this.VotedPerceptronOptions, " ");
        // System.out.println("Random option: " + VotedPerceptronOptions);
        ...
        try {
            ...
            throw new RuntimeException("Failed to set VotedPerceptron classifier options!", ex);
        }
        try {
            theTree.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting VotedPerceptron classifier with " + theTree.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getVotedPerceptronOptions() {
        return VotedPerceptronOptions;
    }

    public void setVotedPerceptronOptions(String VotedPerceptronOptions) {
        this.VotedPerceptronOptions = VotedPerceptronOptions;
    }
