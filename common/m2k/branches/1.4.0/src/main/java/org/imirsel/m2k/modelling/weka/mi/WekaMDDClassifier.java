 ...
 * @author byunggil
 */
public class WekaMDDClassifier implements SignalClassifier {

    weka.classifiers.mi.MDD theRule = null;
    String[] classnames = null;
    private String MDDOptions = "-D";
     ...
     */
    public WekaMDDClassifier(String options) {
        MDDOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MDD.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MDDOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MDD classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MDD classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMDDOptions() {
        return MDDOptions;
    }

    public void setMDDOptions(String MDDOptions) {
        this.MDDOptions = MDDOptions;
    }
