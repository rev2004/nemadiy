...
public class WekaNaiveBayesUpdateableClassifier implements SignalClassifier {

    weka.classifiers.bayes.NaiveBayesUpdateable theRule = null;
    String[] classnames = null;
    private String NaiveBayesUpdateableOptions = "-K";
...
Use kernel estimation for modelling numeric attributes rather than a single normal distribution.
  ...
  */
     ...
     */
    public WekaNaiveBayesUpdateableClassifier() {
    }
     ...
     */
    public WekaNaiveBayesUpdateableClassifier(String options) {
        NaiveBayesUpdateableOptions = options;
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theRule = new NaiveBayesUpdateable();

        // parse options
        StringTokenizer stOption = new StringTokenizer(this.NaiveBayesUpdateableOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set NaiveBayesUpdateable classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting NaiveBayesUpdateable classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getNaiveBayesUpdateableOptions() {
        return NaiveBayesUpdateableOptions;
    }

    public void setNaiveBayesUpdateableOptions(String NaiveBayesUpdateableOptions) {
        this.NaiveBayesUpdateableOptions = NaiveBayesUpdateableOptions;
    }
