 ...
 * @author byunggil
 */
public class WekaMISVMClassifier implements SignalClassifier {

    weka.classifiers.mi.MISVM theRule = null;
    String[] classnames = null;
    private String MISVMOptions = "-D";
     ...
     */
    public WekaMISVMClassifier(String options) {
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MISVM.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MISVMOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MISVM classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MISVM classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMISVMOptions() {
        return MISVMOptions;
    }

    public void setMISVMOptions(String MISVMOptions) {
        this.MISVMOptions = MISVMOptions;
    }
