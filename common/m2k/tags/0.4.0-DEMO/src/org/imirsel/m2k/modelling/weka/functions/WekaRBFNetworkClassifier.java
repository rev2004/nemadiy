/*
 * WekaRBFNetworkClassifier.java
 *Author: Qin Wei
 * Created on November 2, 2006, 2:59 PM
 ...
 * @author kw
 */
public class WekaRBFNetworkClassifier implements SignalClassifier {

    weka.classifiers.functions.RBFNetwork theTree = null;
    String[] classnames = null;
    private String RBFNetworkOptions = "-B";
     ...
     */
    public WekaRBFNetworkClassifier() {
    }

    /**
     * Creates a new instance of TrainWekaClassifier
     *
     * @param options Options for RBFNetworkClassifier
     */
    public WekaRBFNetworkClassifier(String options) {
        RBFNetworkOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.functions.RBFNetwork.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theTree = new RBFNetwork();

        // parse options        
        StringTokenizer stOption = new StringTokenizer(this.RBFNetworkOptions, " ");
        // System.out.println("Random option: " + RBFNetworkOptions);
        ...
        try {
            ...
            throw new RuntimeException("Failed to set RBFNetwork classifier options!", ex);
        }
        try {
            theTree.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting RBFNetwork classifier with " + theTree.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getRBFNetworkOptions() {
        return RBFNetworkOptions;
    }

    public void setRBFNetworkOptions(String RBFNetworkOptions) {
        this.RBFNetworkOptions = RBFNetworkOptions;
    }
