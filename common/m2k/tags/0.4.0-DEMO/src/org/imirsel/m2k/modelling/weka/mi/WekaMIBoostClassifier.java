 ...
 * @author byunggil
 */
public class WekaMIBoostClassifier implements SignalClassifier {

    weka.classifiers.mi.MIBoost theRule = null;
    String[] classnames = null;
    private String MIBoostOptions = "-D";
    ...
    */
     ...
     */
    public WekaMIBoostClassifier(String options) {
        MIBoostOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MIBoost.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MIBoostOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MIBoost classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MIBoost classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMIBoostOptions() {
        return MIBoostOptions;
    }

    public void setMIBoostOptions(String MIBoostOptions) {
        this.MIBoostOptions = MIBoostOptions;
    }
