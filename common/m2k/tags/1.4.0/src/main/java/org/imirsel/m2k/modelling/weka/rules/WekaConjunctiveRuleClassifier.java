 ...
 * @author byunggil
 */
public class WekaConjunctiveRuleClassifier implements SignalClassifier {

    weka.classifiers.rules.ConjunctiveRule theRule = null;
    String[] classnames = null;
    private String ConjunctiveRuleOptions = "-N 5";
    ...
    */
     ...
     */
    public WekaConjunctiveRuleClassifier() {
    }
     ...
     */
    public WekaConjunctiveRuleClassifier(String options) {
        ConjunctiveRuleOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.rules.ConjunctiveRule.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theRule = new ConjunctiveRule();

        // parse options
        StringTokenizer stOption = new StringTokenizer(this.ConjunctiveRuleOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set ConjunctiveRule classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting ConjunctiveRule classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getConjunctiveRuleOptions() {
        return ConjunctiveRuleOptions;
    }

    public void setConjunctiveRuleOptions(String ConjunctiveRuleOptions) {
        this.ConjunctiveRuleOptions = ConjunctiveRuleOptions;
    }
