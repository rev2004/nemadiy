package org.imirsel.m2k.modelling.weka.rules;
 ...
 * @author byunggil
 */
public class WekaDecisionTableClassifier implements SignalClassifier {

    weka.classifiers.rules.DecisionTable theRule = null;
    String[] classnames = null;
    private String DecisionTableOptions = "-X 5 -R";
    Attribute classAttribute = null;

    private boolean verbose = true;

    /*
     -S<t><number of non improving nodes><t>Number of fully expanded non improving subsets to consider before terminating a best first search. Use in conjunction with -B. (Default = 5)<br>
     -X<t><number of folds><t>Use cross validation to evaluate features. Use number of folds = 1 for leave one out CV. (Default = leave one out CV)<br>
     -I<t>Use nearest neighbour instead of global table majority.<br>
     -R<t> Display decision table rules.<br>
     */

    /**
     * Creates a new instance of TrainWekaClassifier
     */
    public WekaDecisionTableClassifier() {
    }
     ...
     */
    public WekaDecisionTableClassifier(String options) {
        DecisionTableOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.rules.DecisionTable.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theRule = new DecisionTable();

        // parse options
        StringTokenizer stOption = new StringTokenizer(this.DecisionTableOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set DecisionTable classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting DecisionTable classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getDecisionTableOptions() {
        return DecisionTableOptions;
    }

    public void setDecisionTableOptions(String DecisionTableOptions) {
        this.DecisionTableOptions = DecisionTableOptions;
    }
