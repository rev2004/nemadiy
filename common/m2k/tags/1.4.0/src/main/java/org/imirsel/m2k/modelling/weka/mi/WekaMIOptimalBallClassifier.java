 ...
 * @author byunggil
 */
public class WekaMIOptimalBallClassifier implements SignalClassifier {

    weka.classifiers.mi.MIOptimalBall theRule = null;
    String[] classnames = null;
    private String MIOptimalBallOptions = "-N 0";
    ...
    */
     ...
     */
    public WekaMIOptimalBallClassifier() {
    }
     ...
     */
    public WekaMIOptimalBallClassifier(String options) {
        MIOptimalBallOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MIOptimalBall.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theRule = new MIOptimalBall();

        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MIOptimalBallOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MIOptimalBall classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MIOptimalBall classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMIOptimalBallOptions() {
        return MIOptimalBallOptions;
    }

    public void setMIOptimalBallOptions(String MIOptimalBallOptions) {
        this.MIOptimalBallOptions = MIOptimalBallOptions;
    }
