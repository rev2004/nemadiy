 ...
 * @author byunggil
 */
public class WekaMIEMDDClassifier implements SignalClassifier {

    weka.classifiers.mi.MIEMDD theRule = null;
    String[] classnames = null;
    private String MIEMDDOptions = "-D";
    Attribute classAttribute = null;

    private boolean verbose = true;
    /*
    -D Output debug information
    -N <num> Whether to 0=normalize/1=standardize/2=neither.
     ...
     */
    public WekaMIEMDDClassifier(String options) {
        MIEMDDOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MIEMDD.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MIEMDDOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MIEMDD classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MIEMDD classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMIEMDDOptions() {
        return MIEMDDOptions;
    }

    public void setMIEMDDOptions(String MIEMDDOptions) {
        this.MIEMDDOptions = MIEMDDOptions;
    }
