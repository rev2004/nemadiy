 ...
 * @author byunggil
 */
public class WekaJRipClassifier implements SignalClassifier {

    weka.classifiers.rules.JRip theRule = null;
    String[] classnames = null;
    private String JRipOptions = "-D";
     ...
     */
    public WekaJRipClassifier(String options) {
        JRipOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.rules.JRip.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.JRipOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set JRip classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting JRip classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getJRipOptions() {
        return JRipOptions;
    }

    public void setJRipOptions(String JRipOptions) {
        this.JRipOptions = JRipOptions;
    }
