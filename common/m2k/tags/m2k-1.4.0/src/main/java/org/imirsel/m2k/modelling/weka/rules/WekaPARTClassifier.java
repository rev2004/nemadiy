 ...
 * @author byunggil
 */
public class WekaPARTClassifier implements SignalClassifier {

    weka.classifiers.rules.PART theRule = null;
    String[] classnames = null;
    private String PARTOptions =  "-Q 22";
    ...
    -M <minimum number of objects>
      ...
      (default 2)
    -R
      Use reduced error pruning. -N <number of folds>
     ...
     */
    public WekaPARTClassifier(String options) {
        PARTOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.rules.PART.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.PARTOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set PART classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting PART classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
