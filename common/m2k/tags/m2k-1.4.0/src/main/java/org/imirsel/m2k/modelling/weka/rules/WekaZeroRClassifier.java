 ...
 * @author byunggil
 */
public class WekaZeroRClassifier implements SignalClassifier {

    weka.classifiers.rules.ZeroR theRule = null;
    String[] classnames = null;
    private String ZeroROptions = "-D";
...
//-D Output debug information
     ...
     */
    public WekaZeroRClassifier(String options) {
        ZeroROptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.rules.ZeroR.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.ZeroROptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set ZeroR classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting ZeroR classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getZeroROptions() {
        return ZeroROptions;
    }

    public void setZeroROptions(String ZeroROptions) {
        this.ZeroROptions = ZeroROptions;
    }
