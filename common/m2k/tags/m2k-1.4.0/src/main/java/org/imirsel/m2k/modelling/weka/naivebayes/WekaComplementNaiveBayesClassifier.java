/*
 * WekaComplementNaiveBayesClassifier.java
 *Author: Qin Wei
 * Created on November 1, 2006, 2:15 PM
...
public class WekaComplementNaiveBayesClassifier implements SignalClassifier {

    weka.classifiers.bayes.ComplementNaiveBayes theRule = null;
    String[] classnames = null;
    private String ComplementNaiveBayesOptions = "-N -S";
...
The smoothing value to use to avoid zero WordGivenClass probabilities (default 1.0). 
    */
     ...
     */
    public WekaComplementNaiveBayesClassifier() {
    }
     ...
     */
    public WekaComplementNaiveBayesClassifier(String options) {
        ComplementNaiveBayesOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.bayes.ComplementNaiveBayes.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theRule = new ComplementNaiveBayes();

        // parse options
        StringTokenizer stOption = new StringTokenizer(this.ComplementNaiveBayesOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set ComplementNaiveBayes classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting ComplementNaiveBayes classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getComplementNaiveBayesOptions() {
        return ComplementNaiveBayesOptions;
    }

    public void setComplementNaiveBayesOptions(String ComplementNaiveBayesOptions) {
        this.ComplementNaiveBayesOptions = ComplementNaiveBayesOptions;
    }
