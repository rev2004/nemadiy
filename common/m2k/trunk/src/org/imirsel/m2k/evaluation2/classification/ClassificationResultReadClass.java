...
public class ClassificationResultReadClass {
    ...
    public static Signal[] readClassificationFileAsSignals(File toRead, File gtFile){
        HashMap<String,String> data = readClassificationFile(toRead);
        HashMap<String,String> groundTruth = readClassificationFile(gtFile);
    ...
    public static HashMap<String,String> readClassificationFile(File toRead){
        ...
        try {
            ...
            try {
                ...
                while (str != null && !str.equals("")) {
                    ...
                    splitted = str.split("\t");
                    dataRead.put(splitted[0], splitted[1]);
                    str = br.readLine();
                }
            } catch (Exception e) {
                e.printStackTrace();
