/*
 * WekaMultilayerPerceptronClassifier.java
 *Author: Qin Wei
 * Created on November 1, 2006, 2:56 PM
 *Graduate School of Library and Information Science
 * University of Illinois at Urbana-Champaign
 */

package org.imirsel.m2k.modelling.weka.functions;
 ...
 * @author kw
 */
public class WekaMultilayerPerceptronClassifier implements SignalClassifier {

    weka.classifiers.functions.MultilayerPerceptron theTree = null;
    String[] classnames = null;
    private String MultilayerPerceptronOptions = "";
     ...
     */
    public WekaMultilayerPerceptronClassifier() {
    }

    /**
     * Creates a new instance of TrainWekaClassifier
     *
     * @param options Options for MultilayerPerceptronClassifier
     */
    public WekaMultilayerPerceptronClassifier(String options) {
        MultilayerPerceptronOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.functions.MultilayerPerceptron.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theTree = new MultilayerPerceptron();

        // parse options        
        StringTokenizer stOption = new StringTokenizer(this.MultilayerPerceptronOptions, " ");
        // System.out.println("Random option: " + MultilayerPerceptronOptions);
        // System.out.println("Random option count: " + stOption.countTokens());
        String[] options = new String[stOption.countTokens()];
        for (int i = 0; i < options.length; i++) {
            options[i] = stOption.nextToken();
            // System.out.println("Random option[" + i + "]: " + options[i]);
        }
        
        try {
            theTree.setOptions(options);
        } catch (Exception ex) {
            throw new RuntimeException("Failed to set MultilayerPerceptron classifier options!", ex);
        }
        try {
            theTree.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MultilayerPerceptron classifier with " + theTree.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMultilayerPerceptronOptions() {
        return MultilayerPerceptronOptions;
    }

    public void setMultilayerPerceptronOptions(String MultilayerPerceptronOptions) {
        this.MultilayerPerceptronOptions = MultilayerPerceptronOptions;
    }
