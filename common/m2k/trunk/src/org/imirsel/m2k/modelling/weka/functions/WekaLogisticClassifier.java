 ...
 * @author kw
 */
public class WekaLogisticClassifier implements SignalClassifier {

    weka.classifiers.functions.Logistic theTree = null;
    String[] classnames = null;
    private String LogisticOptions = "-I 20 -K 0 -S 7 -depth 0 -D";
...
//  may output additional info to the console
     ...
     */
    public WekaLogisticClassifier() {
    }

    /**
     * Creates a new instance of TrainWekaClassifier
     *
     * @param options Options for LogisticClassifier
     */
    public WekaLogisticClassifier(String options) {
    ...
    public String getClassifierName() {
        return weka.classifiers.functions.Logistic.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theTree = new Logistic();

        // parse options        
        StringTokenizer stOption = new StringTokenizer(this.LogisticOptions, " ");
        // System.out.println("Random option: " + LogisticOptions);
        ...
        try {
            ...
            throw new RuntimeException("Failed to set Logistic classifier options!", ex);
        }
        try {
            theTree.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting Logistic classifier with " + theTree.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getLogisticOptions() {
        return LogisticOptions;
    }

    public void setLogisticOptions(String LogisticOptions) {
