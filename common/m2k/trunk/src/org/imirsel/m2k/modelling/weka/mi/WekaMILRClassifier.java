 ...
 * @author byunggil
 */
public class WekaMILRClassifier implements SignalClassifier {

    weka.classifiers.mi.MILR theRule = null;
    String[] classnames = null;
    private String MILROptions = "-D";
    ...
    -R <ridge>
      Set the ridge in the log-likelihood. -A [0|1|2]
     ...
     */
    public WekaMILRClassifier(String options) {
        MILROptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MILR.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MILROptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MILR classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MILR classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMILROptions() {
        return MILROptions;
    }

    public void setMILROptions(String MILROptions) {
        this.MILROptions = MILROptions;
    }
