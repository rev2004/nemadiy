...
public class StatUtil
{
    ...
    /**
     * Compute Inverse Normal Cummulative Distribution
     * @return Inverse Normal Cummulative Distribution
     * @param d arg
     * @param highPrecision arg
     */
    ...
    /**
     *  Coefficient for approximation to erfc in first interval
    */
   ...
   /**
     *  Coefficient for approximation to erfc in second interval
    */
    ...
    */
    ...
    /**
     *  Coefficient for approximation to  erfc  in third interval
    */
    ...
    */
    ...
    /** Constant def for root of pi*/
    private static final double PI_SQRT = Math.sqrt(Math.PI);
    /** Constant def for threshold*/
    ...
    */
    ...
    /**
     * Stub to call calerf with option to calculate erf
     * @see #calerf
     * @param d arg
    ...
    /**
     * Stub to call calerf with option to calculate erfc
     * @see #calerf
     * @param d arg
    ...
    /**
     * Stub to call calerf with option to calculate erfcx
     * @see #calerf
     * @param d arg
