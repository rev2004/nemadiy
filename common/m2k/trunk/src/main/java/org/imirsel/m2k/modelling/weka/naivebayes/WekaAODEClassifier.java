...
public class WekaAODEClassifier implements SignalClassifier {

    weka.classifiers.bayes.AODE theRule = null;
    String[] classnames = null;
    private String AODEOptions = "";
   ...
   Specify the frequency limit for parent attributes.
     ...
     */
    public WekaAODEClassifier(String options) {
        AODEOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.bayes.AODE.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
     ...
     // parse options
        StringTokenizer stOption = new StringTokenizer(this.AODEOptions, " ");
        String[] options;
        if ((this.AODEOptions.indexOf("-B")) == -1) { // doesn't contain "-B"
            ...
            Matcher matcher = pattern.matcher(this.AODEOptions);
        ...
        try {
            ...
            throw new RuntimeException("Failed to set AODE classifier options!", ex);
        }
         ...
         if (this.numBin.equals("")) { // do not discretize input data using unsupervised discretizer
            ...
            try {
                ...
                System.out.println("WEKA: outputting AODE classifier; " + theRule.globalInfo());
            } catch (Exception ex) {
                throw new RuntimeException("Failed to train classifier!", ex);
            }
        }
...
//        }
    ...
    public String getAODEOptions() {
        return AODEOptions;
    }

    public void setAODEOptions(String AODEOptions) {
        this.AODEOptions = AODEOptions;
    }
