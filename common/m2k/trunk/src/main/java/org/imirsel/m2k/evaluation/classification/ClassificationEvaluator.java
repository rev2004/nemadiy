...
package org.imirsel.m2k.evaluation.classification;
...
import org.imirsel.m2k.evaluation.EvaluatorImpl;
import org.imirsel.m2k.evaluation.FriedmansAnovaTkHsd;
import org.imirsel.m2k.evaluation.TaskDescription;
import org.imirsel.m2k.evaluation.resultpages.*;
...
//                    }
    ...
    public Map<String,DataObj> evaluate() throws IllegalArgumentException, IOException{
        ...
        if (hierarchyFile != null){
            ...
            WriteResultFiles.prepFriedmanTestDataCSVOverFolds(jobIDTofoldEvaluations,jobIDToName,classNames,DataObj.CLASSIFICATION_DISCOUNTED_ACCURACY,discountedPerFoldCSV);
        }
