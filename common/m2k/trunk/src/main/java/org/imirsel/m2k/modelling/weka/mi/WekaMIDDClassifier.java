...
import weka.classifiers.mi.MIDD;
 ...
 * @author byunggil
 */
public class WekaMIDDClassifier implements SignalClassifier {

    weka.classifiers.mi.MIDD theRule = null;
    String[] classnames = null;
    private String MIDDOptions = "-D";
    ...
    */
     ...
     */
    public WekaMIDDClassifier(String options) {
        MIDDOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.mi.MIDD.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        // parse options
        StringTokenizer stOption = new StringTokenizer(this.MIDDOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set MIDD classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting MIDD classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getMIDDOptions() {
        return MIDDOptions;
    }

    public void setMIDDOptions(String MIDDOptions) {
        this.MIDDOptions = MIDDOptions;
    }
