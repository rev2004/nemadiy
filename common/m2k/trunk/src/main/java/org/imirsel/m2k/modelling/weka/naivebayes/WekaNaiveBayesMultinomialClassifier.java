/*
 * WekaNaiveBayesMultinomial.java
 *Author: Qin Wei
...
public class WekaNaiveBayesMultinomialClassifier implements SignalClassifier {

    weka.classifiers.bayes.NaiveBayesMultinomial theRule = null;
    String[] classnames = null;
    private String NaiveBayesMultinomialOptions = "";
     ...
     */
    public WekaNaiveBayesMultinomialClassifier() {
    }
     ...
     */
    public WekaNaiveBayesMultinomialClassifier(String options) {
        NaiveBayesMultinomialOptions = options;
    }
    ...
    public String getClassifierName() {
        return weka.classifiers.bayes.NaiveBayesMultinomial.class.getName();
    }
    ...
    public void train(Signal[] inputData) {
        ...
        inputData = null;
        theRule = new NaiveBayesMultinomial();

        // parse options
        StringTokenizer stOption = new StringTokenizer(this.NaiveBayesMultinomialOptions, " ");
        ...
        try {
            ...
            throw new RuntimeException("Failed to set NaiveBayesMultinomial classifier options!", ex);
        }
        try {
            theRule.buildClassifier(trainingDataSet);
            System.out.println("WEKA: outputting NaiveBayesMultinomial classifier; " + theRule.globalInfo());
        } catch (Exception ex) {
...
//        }
    ...
    public String getNaiveBayesMultinomialOptions() {
        return NaiveBayesMultinomialOptions;
    }

    public void setNaiveBayesMultinomialOptions(String NaiveBayesMultinomialOptions) {
        this.NaiveBayesMultinomialOptions = NaiveBayesMultinomialOptions;
    }
