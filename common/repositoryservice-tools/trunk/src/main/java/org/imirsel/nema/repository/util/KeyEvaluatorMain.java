 ...
 * @since 0.4.0
 */
public class KeyEvaluatorMain extends AbstractEvaluatorMainSingleTrack{
	
	public KeyEvaluatorMain(String[] args) {
		super(args, Logger.getLogger(KeyEvaluatorMain.class.getName()));
	}
	
	public static void main(String[] args) throws Exception{
		KeyEvaluatorMain main = new KeyEvaluatorMain(args);
	...
	public List<NemaData> readGTFile(File path) throws IOException{
		SingleTrackEvalFileType reader = new KeyTextFile(); // EDIT FOR OTHER TASKS	    
	...
	public SingleTrackEvalFileType readResultDirectory(File path) throws IOException{
		...
		reader = new KeyTextFile();  // EDIT FOR OTHER TASKS
		reader.getLogger().setLevel(Level.WARNING);
		return reader;
	}
	...
	public Evaluator getEvaluator() {
		Evaluator eval = new KeyEvaluator();	// EDIT FOR OTHER TASKS
		eval.setTask(task);
	...
	public ResultRenderer getRenderer(String matlabPath) throws FileNotFoundException {
		ResultRenderer renderer = new KeyResultRenderer(); // EDIT FOR OTHER TASKS
