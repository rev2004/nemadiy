 ...
 * @since 0.4.0
 */
public class ChordEvaluatorNumberFormatMain extends AbstractEvaluatorMainSingleTrack{
	
	public ChordEvaluatorNumberFormatMain(String[] args) {
		super(args, Logger.getLogger(ChordEvaluatorNumberFormatMain.class.getName()));
	}
	
	public static void main(String[] args) throws Exception{
		ChordEvaluatorNumberFormatMain main = new ChordEvaluatorNumberFormatMain(args);
	...
	public SingleTrackEvalFileType readResultDirectory(File path) throws IOException{
		SingleTrackEvalFileType reader = new ChordNumberTextFile();		    
