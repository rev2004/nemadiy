...
public class MeandreServerProxyFactory {
    ...
    * 
    * @param config The configuration upon which the new 
    ...
    * 
    * @param config The {@link MeandreServerProxyConfig} for which the key
    * will be generated.
    ...
    * 
    * @param jobStatusMonitor Reference to the {@link JobStatusMonitor} the
    * {@link MeandreServerProxy} instances will use to monitor the jobs they
    * are running.
    */
