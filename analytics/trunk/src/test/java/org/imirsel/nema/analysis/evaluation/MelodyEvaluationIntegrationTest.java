...
public class MelodyEvaluationIntegrationTest extends BaseManagerTestCase{
	...
	public void setUp() throws Exception {
        ...
        singleSetDataset.setDescription("Audio Description Contest 2004 (ADC04) Melody transcription vocal dataset collected by Emilia GÃ³mez, Beesuan Ong and Sebastian Streich (MTG-UP)");
