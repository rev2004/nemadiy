...
<form:form commandName="contributor">
	...
	<div class="surround"><label class="fixed required">Last Name:</label><form:input path="lastname"/></div>
        <div class="surround"><label class="fixed required">Email:</label><form:input path="email"/></div>
	<div class="surround"><label class="fixed required">Organization:</label><form:input path="organization"/></div>
	...
	<div class="surround"><label class="fixed ">Home page:</label><form:input path="url" size="25" /></div>
	<div class="surround"><label class="fixed ">From(year):</label><form:input path="startYear" size="5"/>
		<label class="">To:</label><form:input path="endYear" size="5"/></div>
	...
	<div class="surround"><label class="fixed ">Zip (postal) code:</label><form:input path="address.postcode"/></div>
