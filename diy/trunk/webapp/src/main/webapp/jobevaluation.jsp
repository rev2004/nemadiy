...
<head>
    <title><fmt:message key="jobevaluation.title"/></title>
    <meta name="menu" content="jobevaluation"/>
</head>
<body id="jobevaluation"/>
<p class="breadcrumbs" >
<A class="breadcrumbs" HREF="/mainMenu.html"><fmt:message key="mainMenu.title"/></A>
 ...
 > <span class="breadcrumbs"><fmt:message key="jobevaluation.title"/></span> 
</p>


<h1><fmt:message key="jobevaluation.title"/></h1>
                    ...
                    <div id="formcontainer_job">
                        <div class="form_job">
                            <form id="theform" action="jobconfirm_evaluation.jsp" enctype="multipart/form-data" method="post">
                                <fieldset id="pt1">
                                    <label for="jobname">
                                        Job Name
                                    </label>
