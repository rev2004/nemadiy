...
<head>
    <title><fmt:message key="jobconfirm_eval.title"/></title>
    <meta name="menu" content="jobconfirm_eval"/>
</head>
<body id="jobconfirm_eval"/>
<p class="breadcrumbs" >
<A class="breadcrumbs" HREF="/mainMenu.html"><fmt:message key="mainMenu.title"/></A>
 ...
 > <A class="breadcrumbs" HREF="jobevaluation.jsp"><fmt:message key="jobevaluation.title"/></A>
 > <span class="breadcrumbs"><fmt:message key="jobconfirm_eval.title"/></span> 
</p>

<h1><fmt:message key="jobconfirm_eval.title"/></h1>
...
<form id="theform" action="jobevaluation.jsp" enctype="multipart/form-data" method="post">				
                        <div class="form_job">
                            <fieldset id="pt1">
