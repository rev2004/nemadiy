...
public class NemaZipFile {
   ...
   private String systemTmpDir = System.getProperty("java.io.tmpdir");
    ...
    * {@code open()} method must be called immediately after this instance
    * is constructed.
    * 
   ...
   public NemaZipFile(ZipFile zipFile) {
      ...
      System.out.println(systemTmpDir);
   }
   ...
   public boolean containsClass(String className) {
      ...
      try {
         ...
         throw new RuntimeException("An error occured while searching for " +
               "class " + className + " in file " + getSourceZipName() + ".",e);
      }
   ...
   private void makeTempDirForZipContents() {
      sourceZipContentDir = new File(systemTmpDir + fileSeparator + 
