 ...
 */
public class NemaSecurityManager implements JackrabbitSecurityManager {

    private static Logger log = LoggerFactory.getLogger(NemaSecurityManager.class);
    ...
    public void init(Repository repository, Session systemSession) throws RepositoryException {
        ...
        // from configuration
        PrincipalProvider principalProvider = new NemaPrincipalProvider();
        ...
        if (smc != null && smc.getWorkspaceAccessConfig() != null) {
            ...
            workspaceAccessManager = new NemaWorkspaceAccessManager();
        }
    ...
    public AccessManager getAccessManager(Session session, AMContext amContext) throws RepositoryException {
        ...
        try {
            ...
            if (amc == null) {
                accessMgr = new NemaAccessManager();
            } else {
            ...
            String msg = "failed to instantiate AccessManager implementation: " + NemaAccessManager.class.getName();
            log.error(msg, e);
     ...
     */
    private class NemaPrincipalProvider implements PrincipalProvider {

        private final Map<String, Principal> principals = new HashMap<String, Principal>();

        private NemaPrincipalProvider() {
            if (adminID != null) {
